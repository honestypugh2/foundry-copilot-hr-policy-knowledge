...
CAPABILITY_REGISTRY: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec("foundry-rag-evaluators", "Foundry RAG evaluators", "adapter", "partial", "provider-dependent", "responses-relevance-intent-v1", "Microsoft Foundry", "src/benchmarking/evaluation_attachment.py", "BENCHMARK_LINK_FOUNDRY", ("The current publication records structured judge scores and deterministic calibration; native evaluator reports still require normalization for cross-pattern comparison.",), "foundry"),
