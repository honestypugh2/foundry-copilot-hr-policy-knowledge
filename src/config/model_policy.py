...
for Copilot Studio generative orchestration (October 2025); the current
default replacement is **GPT-4.1**, with **GPT-5.x** and **Claude** also
generally available in Microsoft Foundry (June 2026).
...
Usage:
    ...
    model = get_chat_model()                 # env-driven, defaults to gpt-4.1
...
# Chosen because GPT-4o is retired for Copilot Studio generative orchestration
# and GPT-4.1 is its GA replacement. Override via env to use GPT-5.x or Claude.
