...
az deployment sub create \
  ...
  --parameters environmentName=demo location=eastus principalId=$(az ad signed-in-user show --query id -o tsv)
```
...
| `openAIDeploymentName` | string | `gpt-5-mini` | GPT-5-mini deployment name |
...
| `openAIDeploymentName` | GPT-5-mini deployment name |
