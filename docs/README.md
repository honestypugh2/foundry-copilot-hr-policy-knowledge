...
| [ReactBenchmarkWorkbenchADR.md](ReactBenchmarkWorkbenchADR.md) | Architecture decision record: why the workbench stays read-only and where Microsoft-native tools remain authoritative. |
